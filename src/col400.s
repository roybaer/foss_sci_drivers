; COL400.DRV - An SCI video driver for the Sigma Designs Color 400.
...
; Note:
; COL400.DRV has been derived from PCPLUS.DRV.  Do not use it as a
; basis for new drivers.  Use PCPLUS.DRV, directly, instead.
...
driver_name     db      6, "col400"
description     db      35, "Sigma Designs Color 400 - 16 Colors"
...
.draw_odd:
        dec     ch
        ; the Color 400 code makes the loop too long for a short jump
        jz      .draw_y_loop_end
        jmp     .draw_y_loop
.draw_y_loop_end:
